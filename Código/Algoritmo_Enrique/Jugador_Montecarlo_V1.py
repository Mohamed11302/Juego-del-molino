...
from Algoritmo_Enrique.nodo_montecarlo import Nodo_Montecarlo
from Algoritmo_Enrique.Jugador import Jugador

class Jugador_Montecarlo_V1(Jugador):

    def __init__(self, num_procesos, num_iteraciones_montecarlo):

        self.state_inicial = self.cargar_datos("Código/Algoritmo_Enrique/target.json")
