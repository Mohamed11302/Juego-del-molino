...
import random
import sys
from Algoritmo_Enrique.Jugador import Jugador
from Algoritmo_Enrique.Jugador_Aleatorio import Jugador_Aleatorio
import hashlib
...
class Jugador_Q_Learning(Jugador):
    ...
    def __init__(self):
        ...
        self.archivo_0 = "Código/Algoritmo_Enrique/tabla_Q_turno_0.json" #"/content/drive/My Drive/tabla_Q_turno_0.json"
        self.archivo_1 = "Código/Algoritmo_Enrique/tabla_Q_turno_1.json" #"/content/drive/My Drive/tabla_Q_turno_1.json"
        self.ruta_archivo = None
        self.state_inicial = super().cargar_datos("Código/Algoritmo_Enrique/target.json") #super().cargar_datos("/content/drive/My Drive/target.json")
    ...
    def genera_movimiento(self,sucesor_rival):
        if type(sucesor_rival) == tuple:
            sucesor_rival = sucesor_rival[1]
        if sucesor_rival == None: #es el primer turno
            ...
            try:
                ...
                sucesor_rival = json.loads(sucesor_rival)
                estado_origen = sucesor_rival.get("NEXT_STATE")
            ...
            if random.random() <= self.beta: # pasamos de explotación a exploración en ciertas situaciones
                ...
                sucesor_generado = super().devuelve_sucesor(estado_origen,accion_realizar,super().simula_movimiento_sobre_estado(estado_origen,accion_realizar))
            if type(sucesor_generado) == tuple:
                sucesor_generado = sucesor_generado[1]
