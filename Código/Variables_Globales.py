...
TIPO_JUGADOR_MINMAX = "MINMAX"
TIPO_JUGADOR_MONTECARLO1_ENRIQUE = "MONTECARLO1_ENRIQUE"
TIPO_JUGADOR_MONTECARLO2_ENRIQUE = "MONTECARLO2_ENRIQUE"
...
def casillaEnemigaSucesores(gamers,turn,fase): 
        posiciones=[]
        posicionesM=[]
